...
## Tasks
1. [x] Create `RepoService` in frontend and backend route.
2. [x] Build `RepoList` page component.
3. [x] Implement grouping logic (Group by `project.name`).
4. [x] Apply "Sapphire Blue" styling to project headers or active elements.
