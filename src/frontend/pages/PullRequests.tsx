...
export function PullRequests() {
        ...
        return (
            <div style={style}>
                <div
                    ...
                    className="group mx-2 mt-2 p-4 hover:bg-white/5 transition-all flex items-center justify-between cursor-pointer rounded-lg border border-transparent hover:border-zinc-800"
                >
    ...
    return (
        <div className="max-w-7xl mx-auto p-6 h-[calc(100vh-60px)] flex flex-col space-y-6">
            ...
            <div className="flex-1 bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden backdrop-blur-sm relative" ref={containerRef}>
                {loading && !prs.length ? (
                    ...
                    <List
                        ...
                        className="scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent divide-y divide-zinc-800/30"
                    >
                        {Row}
                    </List>
                ) : (
